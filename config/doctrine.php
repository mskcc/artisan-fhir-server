...
return [
    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'connection'    => env('WAREHOUSE_CONNECTION', 'oracle'),
            'namespaces'    => [
                'App\Entities'
            ],
            'paths'         => [
            ...
            */
            'events'        => [
                'listeners'   => [],
                /*
                    If the database connection is a real connection, use this subscriber. If not (e.g.
                    when tests are running) then don't.
                */
                'subscribers' => env('WAREHOUSE_CONNECTION') == 'oracle' ? [Doctrine\DBAL\Event\Listeners\OracleSessionInit::class ] : []
            ],
            'filters'       => [],
            /*
            |--------------------------------------------------------------------------
    ...
    */
    'custom_datetime_functions'  => [
        ...
        'TRUNC' => DoctrineExtensions\Query\Oracle\Trunc::class,
        'TODATE' => DoctrineExtensions\Query\Oracle\ToDate::class,
